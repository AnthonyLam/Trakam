...
public class ListDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListDividerItemDecoration(Context context, int orientation, int leftOffset) {
        this(context, orientation, null, leftOffset);
    }

    public ListDividerItemDecoration(Context context, int orientation, Drawable divider, int leftOffset) {
        if (divider == null) {
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (parent.getChildAdapterPosition(child) == parent.getLayoutManager().getItemCount() - 1) {
                continue;
            }
